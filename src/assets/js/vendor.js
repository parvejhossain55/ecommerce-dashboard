                    ...
                    q = {
                        ...
                        j = function (t, e) {
                            ...
                            if (
                                ...
                                if (
                                    ((n = o.getAttribute("data-pace-" + t)), !e)
                                )
                                    return n;
                                try {
                                    return JSON.parse(n);
                                    ...
                                    if (
                                        ...
                                        (t =
                                            2 <= arguments.length
                                                ? $.call(arguments, 1)
                                                : []),
                                        null != (s = this.bindings)
                                            ? s[n]
                                            : void 0)
                                    ) {
                                        for (
                                            o = 0, u = [];
                                            o < this.bindings[n].length;
                        ...
                        J = 0,
                        Q = (Y = ["ajax", "document", "eventLag", "elements"])
                            .length;
                    J < Q;
                    J++
                )
                ...
                (d = (function (t) {
                    ...
                    (X = function (t) {
                        ...
                        if (!_.length && E.ajax) {
                            ...
                            if (
                                ((e = t.toUpperCase()),
                                nt.call(E.ajax.trackMethods, e) >= 0)
                            )
                                return !0;
                        }
                        return !1;
                    ...
                    (W = function (t) {
                        var e, n, r, o;
                        for (
                            o = E.ajax.ignoreURLs, n = 0, r = o.length;
                            n < r;
                            n++
                        )
                    ...
                    (O = function () {
                        ...
                        if (((o = t.type), (r = t.request), (s = t.url), !W(s)))
                            return f.running ||
                                (!1 === E.restartOnRequestAfter &&
                                    "force" !== X(o))
                                ? void 0
                                : ((n = arguments),
                                  "boolean" ==
                                      typeof (e =
                                          E.restartOnRequestAfter || 0) &&
                                      (e = 0),
                                  setTimeout(function () {
                                      var t, e, s, a, u;
                                      if (
                        ...
                        (this.progress = 0),
                            ...
                            (e = setInterval(function () {
                                ...
                                return (
                                    ...
                                    (n = A()),
                                    o.push(s),
                                    o.length > E.eventLag.sampleCount &&
                                        o.shift(),
                                    (t = k(o)),
...
!(function (e, t) {
    var n = (function (e) {
            ...
            (function (e) {
                ...
                function c(e) {
                    ...
                    var t = u(e),
                        ...
                        o = t.overflowX,
                        r = t.overflowY;
                    return /(auto|scroll|overlay)/.test(n + r + o)
                        ? e
                        : c(d(e));
                }
                var h =
                ...
                function w(e, t) {
                    ...
                    if ((e !== f && t !== f) || o.contains(r))
                        return "BODY" === (s = (a = f).nodeName) ||
                            ("HTML" !== s && g(a.firstElementChild) !== a)
                            ? g(f)
                            : f;
                    var p = b(e);
                    return p.host ? w(p.host, t) : w(e, b(t).host);
                }
                function y(e) {
                    var t =
                ...
                function O() {
                    var e = document.body,
                        ...
                        n = v(10) && getComputedStyle(t);
                    return {
                        height: x("Height", e, t, n),
                        width: x("Width", e, t, n),
                    };
                }
                var L =
                ...
                var J = {
                        ...
                        preventOverflow: {
                            ...
                            fn: function (e, t) {
                                var n =
                                    t.boundariesElement || g(e.instance.popper);
                        ...
                        keepTogether: {
                            ...
                            fn: function (e) {
                                ...
                                return (
                                    n[s] < i(o[f]) &&
                                        (e.offsets.popper[f] = i(o[f]) - n[p]),
                                    n[f] > i(o[s]) &&
                                        (e.offsets.popper[f] = i(o[s])),
                                    e
                                );
                            },
                        },
                        arrow: {
                            ...
                            fn: function (e, t) {
                                ...
                                var g = f[c] + f[l] / 2 - v / 2,
                                    ...
                                    E = g - e.offsets.popper[c] - w - y;
                                return (
                                    (E = Math.max(Math.min(s[l] - v, E), 0)),
                                    (e.arrowElement = r),
                                    (e.offsets.arrow =
                                        (o((n = {}), c, Math.round(E)),
                                        o(n, h, ""),
                        ...
                        inner: {
                            ...
                            fn: function (e) {
                                ...
                                return (
                                    (r[a ? "left" : "top"] =
                                        i[n] -
                                        (s ? r[a ? "width" : "height"] : 0)),
                                    (e.placement = k(t)),
                                    (e.offsets.popper = M(r)),
                                    e
                                );
                            },
                        },
                    ...
                    Z = (function () {
                        function e(t, n) {
                            ...
                            !(function (e, t) {
                                ...
                                Object.keys(
                                    L({}, e.Defaults.modifiers, r.modifiers)
                                ).forEach(function (t) {
        ...
        223: function (e, t, n) {
            ...
            (i.default.Defaults.modifiers.computeStyle.gpuAcceleration = !1),
                (t.Popper = i.default);
        },
    });
    if ("object" == typeof n) {
                ...
                r = (function () {
                    function e(t) {
                        ...
                        if (
                            ...
                            (this._lastWidth = this._horizontal
                                ? window.innerWidth
                                : null),
                        ...
                        i(e, [
                            ...
                            },
                            {
                                ...
                                value: function (e, t) {
                                    ...
                                    for (
                                        var s = 0,
                                            o = (n = n.slice(0, n.indexOf(i)))
                                                .length;
                                        s < o;
                                        s++
                                    )
                                        if (
                                            (n[s].classList.add("open"),
                                            this._accordion)
                                        )
                                            for (
                                                var r = this._findChild(
                                                        n[s].parentNode,
                                                        ["sidenav-item", "open"]
                                                    ),
                                                    l = 0,
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    ...
                                    "next" === e
                                        ? ((i = this._getSlideNextPos()),
                                          n + i < t && (i = t - n))
                                        : (i = this._getSlidePrevPos()) > 0 &&
                                          (i = 0),
                            ...
                            },
                            {
                                ...
                                value: function (e) {
                                    for (
                                        var t = this._inner.childNodes[0],
                                            n = 0;
                                        t !== e;
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    (this._evntElClick = function (t) {
                                        var n = t.target.classList.contains(
                                            "sidenav-toggle"
                                        )
                                            ? t.target
                                            : e._findParent(
                                        ...
                                        this._horizontal &&
                                            ...
                                            (this._evntNextBtnClick = function (
                                                t
                                            ) {
                                                t.preventDefault(),
                                                    e._nextBtn.classList.contains(
                                                        "disabled"
                                                    ) || e._slide("next");
                                            }),
            ...
            var a = ["transitionend", "webkitTransitionEnd", "oTransitionEnd"],
                ...
                r = {
                    ...
                    _getAnimationDuration: function (t) {
                        ...
                        return (
                            parseFloat(e) * (-1 !== e.indexOf("ms") ? 1 : 1e3)
                        );
                    },
                    ...
                    _bindLayoutAnimationEndEvent: function (t, e) {
                        ...
                        (this._transitionCallback = function (t) {
                            t.target === n &&
                                (i._unbindLayoutAnimationEndEvent(), e.call(i));
                        }),
                            a.forEach(function (t) {
                                n.addEventListener(
                                    t,
                                    i._transitionCallback,
                                    !1
                                );
                            }),
                            t.call(this),
                    ...
                    isFixed: function () {
                        return this._hasClass(
                            "layout-fixed layout-fixed-offcanvas"
                        );
                    },
                    isOffcanvas: function () {
                        return this._hasClass(
                            "layout-offcanvas layout-fixed-offcanvas"
                        );
                    },
                    isNavbarFixed: function () {
                        return (
                            this._hasClass("layout-header-fixed") ||
                            (!this.isSmallScreen() &&
                                this.isFixed() &&
                                this.isLayout1())
                        );
                    ...
                    setAutoUpdate: function () {
                        ...
                        e && !this._autoUpdate
                            ? (this.on(
                                  "resize.layoutHelpers:autoUpdate",
                                  function () {
                                      return t.update();
                                  }
                              ),
                        ...
                        this._initialized ||
                            ...
                            this.on("init._layoutHelpers", function () {
                                t.off("resize._layoutHelpers:redrawSidenav"),
                                    t.on(
                                        "resize._layoutHelpers:redrawSidenav",
                                        function () {
                                            t.isSmallScreen() &&
                                                !t.isCollapsed() &&
                                    ...
                                    "number" == typeof document.documentMode &&
                                        ...
                                        (t.off(
                                            "resize._layoutHelpers:ie10RepaintBody"
                                        ),
                                        t.on(
                                            "resize._layoutHelpers:ie10RepaintBody",
                                            function () {
                        ...
                        (t.attach = function (t, e) {
                            ...
                            for (var i = 0, s = t.length; i < s; i++)
                                (r = t[i]),
                                    ...
                                    -1 ===
                                        r.className.indexOf("waves-effect") &&
            ...
            function s(t) {
                ...
                return (
                    ...
                    (t.tagName &&
                        ...
                        (-1 !==
                            t.parentNode.parentNode.className.indexOf(
                                "dropdown-menu"
                            ) ||
                            -1 !==
                                t.parentNode.parentNode.className.indexOf(
