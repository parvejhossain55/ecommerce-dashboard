...
const profile = "../../assets/img/avatars/1.png";

function NavbarHeader() {
    return (
        <nav
            className="layout-navbar navbar navbar-expand-lg align-items-lg-center bg-white container-p-x"
            id="layout-navbar"
        >
                ...
                <div className="navbar-nav align-items-lg-center ml-auto">
                    <div className="demo-navbar-notifications nav-item dropdown mr-lg-3">
                        ...
                        <div className="dropdown-menu dropdown-menu-right">
                            <div className="bg-dark text-center text-white font-weight-bold p-3">
                                4 New Notifications
                            </div>
                            <div className="list-group list-group-flush">
                                ...
                                <a
                                    ...
                                    className="list-group-item list-group-item-action media d-flex align-items-center"
                                >
                                    <div className="ui-icon ui-icon-sm feather icon-user-plus bg-info border-0 text-white"></div>
                                    <div className="media-body line-height-condenced ml-3">
                                        <div className="text-dark">
                                            You have
                                ...
                                <a
                                    ...
                                    className="list-group-item list-group-item-action media d-flex align-items-center"
                                >
                                    <div className="ui-icon ui-icon-sm feather icon-alert-triangle bg-warning border-0 text-white"></div>
                                    <div className="media-body line-height-condenced ml-3">
                                        <div className="text-dark">
                                            99% server load
                                        </div>
                            ...
                            <a
                                href="javascript:"
                                className="d-block text-center text-muted small p-2 my-1"
                            >
